...
2. In the newly-appeared Rig Builder, under the R15 tab, click Block Avatar(red in image).
   ...
   ![image-20230330183333821](C:\Users\vnano\AppData\Roaming\Typora\typora-user-images\image-20230330183333821.png)

3. You should see your Dummy appear. Take some time to color it if you'd like.

   ![image-20230330183400580](C:\Users\vnano\AppData\Roaming\Typora\typora-user-images\image-20230330183400580.png)
